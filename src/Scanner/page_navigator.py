...
class PageNavigator:
    def __init__(self, browser: Browser, username: str,
    ...
    def enter_username(self) -> None:
        ...
        selector_element = self.__page.query_selector(
    ...
    def reenter_password(self) -> None:
        ...
        if selector_element:
            ...
            self.__page.locator(
                '#sensitiveZone_password').fill(self.__password)
